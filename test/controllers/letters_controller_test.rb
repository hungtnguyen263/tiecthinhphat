...
class LettersControllerTest < ActionController::TestCase
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post :create, letter: { content: @letter.content, image_url: @letter.image_url, title: @letter.title }
    end
  ...
  test "should update letter" do
    patch :update, id: @letter, letter: { content: @letter.content, image_url: @letter.image_url, title: @letter.title }
    assert_redirected_to letter_path(assigns(:letter))
  end
