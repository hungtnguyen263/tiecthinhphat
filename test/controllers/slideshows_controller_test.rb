...
class SlideshowsControllerTest < ActionController::TestCase
  ...
  test "should create slideshow" do
    assert_difference('Slideshow.count') do
      post :create, slideshow: { content: @slideshow.content, image_url: @slideshow.image_url, position: @slideshow.position, title: @slideshow.title }
    end
  ...
  test "should update slideshow" do
    patch :update, id: @slideshow, slideshow: { content: @slideshow.content, image_url: @slideshow.image_url, position: @slideshow.position, title: @slideshow.title }
    assert_redirected_to slideshow_path(assigns(:slideshow))
  end
